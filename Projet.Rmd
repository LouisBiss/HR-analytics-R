...
#fig <- fig %>% 
 # add_trace(
  #  EmployeeID=df_sunburst$EmployeeID,
   # Department=df_sunburst$Department,
    #JobSatisfaction=df_sunburst$JobSatisfaction,
...
```{r}
unique(df_global$JobRole)
```

```{r}
library("ggplot2")

ggplot(df_global,                         # Draw barplot with grouping & stacking
       aes('Sales Representative' = JobRole,
           'Healthcare Representative' = JobRole,
           'Human Resources' = JobRole,
           'Manufacturing Director' = JobRole,
           'Research Scientist' = JobRole,
           'Sales Executive' = JobRole,
           'Laboratory Technician' = JobRole,
           'Manager' = JobRole,
           fill = stack)) + 
