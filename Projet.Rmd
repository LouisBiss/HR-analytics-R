...
melted <- melt(df_global, "Departement")

melted$cat <- ''
melted[melted$variable == 'Healthcare Representative',]$cat <- "Healthcare Representative"
melted[melted$variable != 'Human Resources',]$cat <- "Human Resources"
